...
def sort_list(new_list):
    ...
    #Setting the loop to false to start the loop
    sorting_hat = False
    ...
    while not sorting_hat:
        #Setting loop to True to end it if the list is sorted
        sorting_hat = True
        ...
        for i in range(listlen):
            if new_list[i] > new_list[i+1]:
                    ...
                    #Setting loop back to false to continue as the list still needs to be sorted
                    sorting_hat = False
